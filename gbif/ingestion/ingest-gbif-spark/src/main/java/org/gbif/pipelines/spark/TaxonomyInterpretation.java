...
import static org.gbif.pipelines.spark.OccurrenceInterpretation.*;
...
public class TaxonomyInterpretation {
  ...
  public static void main(String[] argsv) throws Exception {
    ...
    SparkSession spark =
        getSparkSession(
            args.master, args.appName, config, TaxonomyInterpretation::configSparkSession);
    FileSystem fileSystem = getFileSystem(spark, config);
    /* ############ standard init block - end ########## */

    runTaxonomy(spark, fileSystem, config, datasetId, attempt);
            ...
            (MapFunction<Occurrence, Occurrence>)
                simpleRecord -> {
                  ...
                  return Occurrence.builder()
                      ...
                      .clustering(simpleRecord.clustering)
                      .build();
                },
