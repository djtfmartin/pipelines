...
@Slf4j
public class InterpretationCallback implements MessageCallback<PipelinesVerbatimMessage> {
  ...
  private final StepType stepType = StepType.VERBATIM_TO_INTERPRETED;
