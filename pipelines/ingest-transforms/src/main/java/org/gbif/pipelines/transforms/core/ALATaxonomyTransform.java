...
import org.gbif.pipelines.core.interpreters.specific.ALATaxonomyInterpreter;
...
import static org.gbif.pipelines.common.PipelinesVariables.Metrics.ALA_TAXON_RECORDS_COUNT;
...
public class ALATaxonomyTransform extends Transform<ExtendedRecord, ALATaxonRecord> {
  ...
  private ALATaxonomyTransform(KeyValueStore<SpeciesMatchRequest, NameUsageMatch> kvStore, KvConfig kvConfig) {
    super(ALATaxonRecord.class, ALA_TAXONOMY, ALATaxonomyTransform.class.getName(), ALA_TAXON_RECORDS_COUNT);
  ...
  @Setup
  public void setup() {
    //initialise http connector stuff...
