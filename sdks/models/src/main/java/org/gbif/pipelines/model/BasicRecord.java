...
public interface BasicRecord extends Record, Issues {
  ...
  List<? extends AgentIdentifier> getIdentifiedByIds();

  void setIdentifiedByIds(List<? extends AgentIdentifier> identifiedByIds);
  ...
  void setRecordedByIds(List<? extends AgentIdentifier> recordedByIds);
