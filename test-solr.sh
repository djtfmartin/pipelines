...
java -XX:+UseG1GC -Xms1G -Xmx4G -jar /Users/mar759/dev/pipelines/pipelines/ingest-gbif-standalone/target/ingest-gbif-standalone-2.2.32-SNAPSHOT-shaded.jar \
 --pipelineStep=INTERPRETED_TO_SOLR_INDEX \
 ...
 --properties=/Users/mar759/dev/pipelines/pipelines.properties \
