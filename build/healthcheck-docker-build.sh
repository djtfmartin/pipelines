...
docker build -f ./gbif/ingestion/${MODULE}/docker/DockerfileStandalone ./gbif/ingestion/${MODULE} --build-arg VERSION=${POM_VERSION} --build-arg JAR_FILE=${MODULE}-${POM_VERSION}.jar -t ${IMAGE}
